...
function addContent() {
	...
	*/
	...
	/*
		First we get the value of the text the user wants to add.
		For this we use the jquery val since it'll get us the
		value contained in the field.
	*/	
	let newInput = $('#newPostText').val();
	let newImage = $('#userNewPic').val();
